...
//---------------------------------------------------------------------------------------------------------------------------
			...
			$subMenu->addItem(
				new MenuItem( 'Nicht Alkoholische', '/home/index?typ=2&option=nal', $subSubMenu )
			);
