...
--
-- Host: localhost
-- Erstellungszeit: 14. Nov 2016 um 10:45
...
--
-- Erstellt am: 14. Nov 2016 um 09:33
--
...
--
-- TRUNCATE Tabelle vor dem Einfügen `Addenda`
--

TRUNCATE TABLE `Addenda`;
--
...
--
-- TRUNCATE Tabelle vor dem Einfügen `AddendaToComponets`
--

TRUNCATE TABLE `AddendaToComponets`;
--
...
--
-- Erstellt am: 14. Nov 2016 um 09:36
--
...
--
-- TRUNCATE Tabelle vor dem Einfügen `Campaigns`
--
...
--
-- Erstellt am: 14. Nov 2016 um 09:35
--
...
--
-- TRUNCATE Tabelle vor dem Einfügen `Descriptions`
--
...
--
-- TRUNCATE Tabelle vor dem Einfügen `ProductComponentReplaceable`
--

TRUNCATE TABLE `ProductComponentReplaceable`;
--
...
--
-- TRUNCATE Tabelle vor dem Einfügen `ProductsToBasicProducts`
--

TRUNCATE TABLE `ProductsToBasicProducts`;
--
...
--
-- TRUNCATE Tabelle vor dem Einfügen `Sliders`
--
...
--
-- Constraints der Tabelle `AddendaToComponets`
--
ALTER TABLE `AddendaToComponets`
  ADD CONSTRAINT `FK_AddonsToComponets_Addenda` FOREIGN KEY (`fk_Addenda`) REFERENCES `Addenda` (`id`),
  ADD CONSTRAINT `FK_AddonsToComponets_Components` FOREIGN KEY (`fk_Components`) REFERENCES `Components` (`componentId`);
...
ALTER TABLE `Components`
  ...
  ADD CONSTRAINT `FK_Components_MediaFiles` FOREIGN KEY (`fk_MediaFiles`) REFERENCES `MediaFiles` (`id`);

--
-- Constraints der Tabelle `Customers`
--
ALTER TABLE `Customers`
  ADD CONSTRAINT `Customers_ibfk_1` FOREIGN KEY (`customerGroup`) REFERENCES `CustomerGroups` (`id`);
...
--
-- Constraints der Tabelle `ProductsToBasicProducts`
--
ALTER TABLE `ProductsToBasicProducts`
  ADD CONSTRAINT `FK_ProductToOptions_Products_ibfk_1` FOREIGN KEY (`productId`) REFERENCES `Products` (`id`),
  ADD CONSTRAINT `FK_ProductToOptions_Products_ibfk_2` FOREIGN KEY (`basicProductId`) REFERENCES `Products` (`id`);
...
--
-- Metadaten für Tabelle AddendaToComponets
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle Campaigns
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle ComponentGroups
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle Components
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle CustomerGroups
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle Customers
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle Descriptions
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle MediaFiles
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle ProductComponentReplaceable
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle ProductGroups
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle ProductGroupTeaser
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle Products
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle ProductsToBasicProducts
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle ProductsToComponents
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Tabelle ProductsToProductGroups
--
...
TRUNCATE TABLE `pma__tracking`;
--
-- Metadaten für Datenbank vagrant
--
...
--
-- TRUNCATE Tabelle vor dem Einfügen `pma__pdf_pages`
--
...
--
-- TRUNCATE Tabelle vor dem Einfügen `pma__table_coords`
--
