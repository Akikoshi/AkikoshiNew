...
--
-- Host: localhost
-- Erstellungszeit: 21. Sep 2016 um 10:10
...
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Hear are the basic products, the variants and the package pr';
